...
pub struct Options {
    ...
    global_announce_servers: Vec<AnnounceServer>,
    ...
    /// devices.
    reconnection_interval_s: Seconds,
    ...
    progress_update_interval_s: Seconds,
    ...
    min_home_disk_free: MinDiskFree,
    ...
    stun_keepalive_start_s: Seconds,
    /// Minimum for the `stun_keepalive_start_s` interval, in seconds.
    stun_keepalive_min_s: Seconds,
    ...
    send_full_index_on_upgrade: bool,
    ...
    insecure_allow_old_tls_versions: bool,
}
